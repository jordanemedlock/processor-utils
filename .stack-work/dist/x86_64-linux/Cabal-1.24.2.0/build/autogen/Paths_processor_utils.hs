...
getLibDir = catchIO (getEnv "processor_utils_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "processor_utils_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "processor_utils_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "processor_utils_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "processor_utils_sysconfdir") (\_ -> return sysconfdir)
