...
/* package processor-utils-0.1.0.0 */
#define VERSION_processor_utils "0.1.0.0"
#define MIN_VERSION_processor_utils(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "processor-utils-0.1.0.0-1y3SvWWBO3LLmYnHgh4BDl"

#define CURRENT_PACKAGE_KEY "processor-utils-0.1.0.0-1y3SvWWBO3LLmYnHgh4BDl"
